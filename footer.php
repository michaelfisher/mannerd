...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info">
				...
				<div id="social-icons">
					<a id="facebook" target="_blank" href="http://facebook.com/mannerdisms"><i class="fa fa-facebook fa-fw fa-3x"></i></a><a id="twitter" target="_blank" href="http://twitter.com/mannerdisms"><i class="fa fa-twitter fa-fw fa-3x"></i></a><a id="pinterest" target="_blank" href="http://pinterest.com/mannerdisms"><i class="fa fa-pinterest fa-fw fa-3x"></i></a>
				</div>
